...
if __name__ == "__main__":
    ...
    cfg_file_path = (ROOT_DIR + "/module/files/CFGsample.cfg").replace("/", "\\")
    conf_file_path = (ROOT_DIR + "/module/files/CONFsample.conf").replace("/", "\\")
    ...
    configparser = ConfigParser(cfg_file_path, json_file_path, env_file_path)
